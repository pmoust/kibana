...
// prettier-ignore
const StreamsAlertRequired = rt.type({
...
// prettier-ignore
export const StreamsAlertSchema = rt.intersection([StreamsAlertRequired, StreamsAlertOptional, AlertSchema]);
// prettier-ignore
export type StreamsAlert = rt.TypeOf<typeof StreamsAlertSchema>;
